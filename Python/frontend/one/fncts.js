...
console.log(statesArray);
  ...
  if( endDate.length>0){
        ...
        console.log(urlBody);
        console.clear();
        STRINGTOPRINT=$("#origin").val()+' - '+$("#destination").val();
        url=urlStart+urlBody+urlFoot;
      
        // console.log("url='"+url+"'\n\STRINGTOPRINT='"+;
var txt='url="'+url+'"\\\n\\\n\\\nSTRINGTOPRINT="'+STRINGTOPRINT +' "'
        $("#myInput").val(txt);
        // $("#myInput").val("var url='"+url+"';var stops="+stops+";var actualTime='"+actualTime+"';var origincity='"+$("#origin").val()+" - "+$("#destination").val() +" ', payOut='"+$("#minpay").val()+"', perMile='"+$("#minper").val()+"',nyich="+nyich+"; var bkt="+$("#bk").val()+";var statesArray="+JSON.stringify(statesArray)+";clear();eval(localStorage.getItem('dsh_mnt'));");



        myFunction();
        download('startONE.cmd','echo Starting\n\npython C:/Users/Administrator/one1/masterone.py "'+url+'" "'+STRINGTOPRINT+'"\n\necho Finished\npause')
